...
export class DonsService {
  ...
  save(info:any){
    return this.http.post(BaseUrl+'dons/add',JSON.stringify(info),httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return {
          tuteur: response
  ...
  FindById(id:any){
    return this.http.get(BaseUrl+'dons/findById/'+id,httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return response
      }),
  ...
  Update(info:any){
    return this.http.post(BaseUrl+'dons/update',JSON.stringify(info),httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return {
          tuteur: response
  ...
  getList(){
    return this.http.get(BaseUrl+'dons/liste',httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return response
      }),
  ...
  getAll(): Observable<any[]> {
    return this.http.get<any[]>(BaseUrl + 'dons/liste');
  }
