...
export class ProfilService {
  ...
  save(info:any){
    return this.http.post(BaseUrl+'proffiladd',JSON.stringify(info),httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return response
      }),
  ...
  FindById(id:any){
    return this.http.get(BaseUrl+'profil/findById/'+id,httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return response
      }),
  ...
  Update(info:any){
    return this.http.post(BaseUrl+'profil/update',JSON.stringify(info),httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return {
          tuteur: response
  ...
  getList(){
    return this.http.get(BaseUrl+'profil/liste',httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return response
      }),
  ...
  getAll(): Observable<any[]> {
    return this.http.get<any[]>(BaseUrl + 'profil/liste');
  }
