...
export class TuteurService {
  ...
  save(info:any){
    return this.http.post(BaseUrl+'tuteur/add',JSON.stringify(info),httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return {
          tuteur: response
      ...
      catchError(async () => console.log("Add transaction genrrerreur"))
    )
  }
  
  FindById(id:any){
    return this.http.get(BaseUrl+'tuteurfindById/'+id,httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return response
      }),
  ...
  Update(info:any){
    return this.http.post(BaseUrl+'tuteur/update',JSON.stringify(info),httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return {
          tuteur: response
  ...
  getList(){
    return this.http.get(BaseUrl+'tuteur/liste',httpOptions).pipe(
      tap((data: any)=> console.log(data)),
      map((response: any) =>{
        return response
      }),
  ...
  getAll(): Observable<any[]> {
    return this.http.get<any[]>(BaseUrl + 'transaction/liste');
  }
