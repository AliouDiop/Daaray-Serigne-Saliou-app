...
@Component({
  selector: 'app-dialog-addadoption',
  templateUrl: './dialog-addadoption.component.html',
  styleUrls: ['./dialog-addadoption.component.scss']
})
export class DialogAddadoptionComponent implements OnInit, OnDestroy {
  @Input() info: any;
  isLoading = false;
  //infoo:any=this.info;
