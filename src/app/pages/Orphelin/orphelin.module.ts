...
import { OrphelinRoutingModule } from './orphelin-routing.module';
...
@NgModule({
  declarations: [OrphelinComponent, AddorphelinComponent, EditOrphelinComponent, ListorphelinComponent],
  imports: [
    CommonModule,
    OrphelinRoutingModule,
    WidgetsModule,
    MatSelectModule,
